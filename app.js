...
const mongoUrl = "mongodb+srv://jaimathiji:jayam@student.krrhx.mongodb.net/ExpenseTracker";
...
app.get("/app/:collectionName", async (req, res) => {
    ...
    try {
      ...
      res.status(500).json({ message: "Error fetching data from collection", error: error.message });
    }
  });
